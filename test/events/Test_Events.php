 ...
 * @author     Boltunov Artem <dev@bluescarf.ru>
    ...
    class Test_Events extends PHPUnit_Framework_TestCase
    {
         ...
         */
        public function can_report_events(): void
        {
            $eventNames            = [
                'AsyncAGI',
                'AGIExec',
         ...
         * @throws ClientException
         */
        private function _testEvent($eventName, array $getters, array $values, array $translatedValues): void
        {
            ...
            foreach ($values as $key => $value) {
                ...
                $this->assertTrue(
                    ...
                    sprintf('Method %s doesn\'t exixt in event %s', $methodName, $event ? get_class($event) : '')
                );
